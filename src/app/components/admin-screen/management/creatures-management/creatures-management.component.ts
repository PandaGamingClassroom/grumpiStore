...
@Component({
  selector: 'app-creatures-management',
  standalone: true,
  imports: [
    RouterLink,
  ...
  templateUrl: './creatures-management.component.html',
  styleUrl: './creatures-management.component.scss',
})
export class CreaturesManagementComponent {
